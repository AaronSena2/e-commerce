...
/* Category list shared between sidebar and mobile pill bar */
$categories = [
...
<!-- Mobile horizontal category bar (visible < lg) -->
<div class="mp-cat-bar">
...
<div class="mp-layout">
    ...
    <aside class="mp-sidebar">
        ...
        <!-- Privacy blurb (same as FB Marketplace) -->
        <p style="font-size:.75rem;color:var(--fb-text-2);padding:.25rem 1rem 0;line-height:1.5;">
            <a href="#" style="color:var(--fb-text-2);">Privacy</a> ·
            <a href="#" style="color:var(--fb-text-2);">Terms</a> ·
            <a href="#" style="color:var(--fb-text-2);">Cookies</a><br>
            &copy; <?= date('Y') ?> ShopMVP
        </p>
    </aside>
